...
CREATE INDEX IDX_AVISOS_ATIVO ON AVISOS(AVI_ATIVO, D_E_L_E_T_);
...
CREATE INDEX IDX_RPT_PORTAL_EXTRATOS_UNIDADE ON RPT_PORTAL_EXTRATOS(REX_UNIDADE, D_E_L_E_T_);
CREATE INDEX IDX_RPT_PORTAL_EXTRATOS_COMPETENCIA ON RPT_PORTAL_EXTRATOS(REX_COMPETENCIA, D_E_L_E_T_);
CREATE INDEX IDX_RPT_PORTAL_EXTRATOS_STATUS ON RPT_PORTAL_EXTRATOS(REX_STATUS, D_E_L_E_T_);
...
CREATE INDEX IDX_RPT_PORTAL_AGENDA_UNIDADE ON RPT_PORTAL_AGENDA(REA_UNIDADE, D_E_L_E_T_);
CREATE INDEX IDX_RPT_PORTAL_AGENDA_VENCIMENTO ON RPT_PORTAL_AGENDA(REA_VENCIMENTO, D_E_L_E_T_);
